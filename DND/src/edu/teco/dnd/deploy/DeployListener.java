...
public interface DeployListener {
	...
	/**
	 * This method is called if the deployment fails. Other methods of the listener may still be called afterwards due to race conditions; these
	 * calls should be ignored.
	 * 
	 * @param appId the UUID of the Application that failed
	 * @param cause the cause of the failure if know or null otherwise
	 */
