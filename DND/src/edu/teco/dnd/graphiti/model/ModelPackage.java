...
public interface ModelPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link edu.teco.dnd.graphiti.model.impl.FunctionBlockModelImpl
	 * <em>Function Block Model</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The feature id for the '<em><b>Inputs</b></em>' containment reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The feature id for the '<em><b>Block Name</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The feature id for the '<em><b>Function Block</b></em>' container reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The number of structural features of the '<em>Option Model</em>' class. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The meta object id for the '{@link edu.teco.dnd.graphiti.model.impl.OutputModelImpl <em>Output Model</em>}'
	 * class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The number of structural features of the '<em>Output Model</em>' class. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The meta object id for the '<em>Serializable</em>' data type. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The meta object id for the '<em>Function Block</em>' data type. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for class '{@link edu.teco.dnd.graphiti.model.FunctionBlockModel
	 * <em>Function Block Model</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the attribute '{@link edu.teco.dnd.graphiti.model.FunctionBlockModel#getType
	 ...
	 * {@link edu.teco.dnd.graphiti.model.FunctionBlockModel#getInputs <em>Inputs</em>}'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the containment reference list '
	 * {@link edu.teco.dnd.graphiti.model.FunctionBlockModel#getOutputs <em>Outputs</em>}'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the containment reference list '
	 * {@link edu.teco.dnd.graphiti.model.FunctionBlockModel#getOptions <em>Options</em>}'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the attribute '{@link edu.teco.dnd.graphiti.model.FunctionBlockModel#getID
	...
	/**
	 * Returns the meta object for the attribute '{@link edu.teco.dnd.graphiti.model.FunctionBlockModel#getPosition
	...
	/**
	 * Returns the meta object for the attribute '{@link edu.teco.dnd.graphiti.model.FunctionBlockModel#getBlockName
	 * <em>Block Name</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * {@link edu.teco.dnd.graphiti.model.InputModel#getFunctionBlock <em>Function Block</em>}'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the reference '{@link edu.teco.dnd.graphiti.model.InputModel#getOutput
	...
	/**
	 * Returns the meta object for the attribute '{@link edu.teco.dnd.graphiti.model.OptionModel#getValue
	...
	/**
	 * Returns the meta object for the container reference '
	 * {@link edu.teco.dnd.graphiti.model.OptionModel#getFunctionBlock <em>Function Block</em>}'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the container reference '<em>Function Block</em>'.
	...
	/**
	 * Returns the meta object for the container reference '
	 * {@link edu.teco.dnd.graphiti.model.OutputModel#getFunctionBlock <em>Function Block</em>}'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the container reference '<em>Function Block</em>'.
	...
	/**
	 * Returns the meta object for the reference list '{@link edu.teco.dnd.graphiti.model.OutputModel#getInputs
	...
	/**
	 * Returns the meta object for data type '{@link java.io.Serializable <em>Serializable</em>}'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link edu.teco.dnd.graphiti.model.impl.FunctionBlockModelImpl
		 * <em>Function Block Model</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @see edu.teco.dnd.graphiti.model.impl.FunctionBlockModelImpl
		 * @see edu.teco.dnd.graphiti.model.impl.ModelPackageImpl#getFunctionBlockModel()
		...
		/**
		 * The meta object literal for the '<em><b>Block Name</b></em>' attribute feature. <!-- begin-user-doc --> <!--
		 * end-user-doc -->
		 * 
		 * @generated
		 */
		 ...
		 * <em>Option Model</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @see edu.teco.dnd.graphiti.model.impl.OptionModelImpl
		 * @see edu.teco.dnd.graphiti.model.impl.ModelPackageImpl#getOptionModel()
		 * @generated
		...
		/**
		 * The meta object literal for the '{@link edu.teco.dnd.graphiti.model.impl.OutputModelImpl
		 * <em>Output Model</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @see edu.teco.dnd.graphiti.model.impl.OutputModelImpl
		 * @see edu.teco.dnd.graphiti.model.impl.ModelPackageImpl#getOutputModel()
		 * @generated
		...
		/**
		 * The meta object literal for the '<em>Serializable</em>' data type. <!-- begin-user-doc --> <!-- end-user-doc
		 * -->
		 * 
		 * @see java.io.Serializable
		 * @see edu.teco.dnd.graphiti.model.impl.ModelPackageImpl#getSerializable()
		...
		/**
		 * The meta object literal for the '<em>Function Block</em>' data type. <!-- begin-user-doc --> <!--
		 * end-user-doc -->
		 * 
		 * @see edu.teco.dnd.blocks.FunctionBlock
		 * @see edu.teco.dnd.graphiti.model.impl.ModelPackageImpl#getFunctionBlock()
