...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Output Model</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class OutputModelImpl extends EObjectImpl implements OutputModel {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.OUTPUT_MODEL__NAME, oldName,
					name));
	}
	...
	public NotificationChain basicSetFunctionBlock(FunctionBlockModel newFunctionBlock, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newFunctionBlock,
				ModelPackage.OUTPUT_MODEL__FUNCTION_BLOCK, msgs);
		return msgs;
	}
	...
	public EList<InputModel> getInputs() {
		if (inputs == null) {
			inputs = new EObjectWithInverseResolvingEList<InputModel>(InputModel.class, this,
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.OUTPUT_MODEL__TYPE, oldType,
					type));
	}
