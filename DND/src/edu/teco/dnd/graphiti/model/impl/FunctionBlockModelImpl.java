 ...
 * <li>{@link edu.teco.dnd.graphiti.model.impl.FunctionBlockModelImpl#getBlockClass <em>Block Class</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class FunctionBlockModelImpl extends EObjectImpl implements FunctionBlockModel {
	...
	/**
	 * The cached value of the '{@link #getInputs() <em>Inputs</em>}' containment reference list. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getInputs()
	 * @generated
	 ...
	 * @ordered
	 */
	protected static final String POSITION_EDEFAULT = Messages.BLOCK_DEFAULT_POSITION;
	...
	/**
	 * The default value of the '{@link #getBlockName() <em>Block Name</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getBlockName()
	 * @generated
	 * @ordered
	 */
	protected static final String BLOCK_NAME_EDEFAULT = Messages.BLOCK_DEFAULT_BLOCKNAME;
	...
	/**
	 * The default value of the '{@link #getBlockClass() <em>Block Class</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getBlockClass()
	 * @generated
	 * @ordered
	 */
	protected static final String BLOCK_CLASS_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getBlockClass() <em>Block Class</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getBlockClass()
	 * @generated
	 * @ordered
	 */
	protected String blockClass = BLOCK_CLASS_EDEFAULT;
	...
	protected FunctionBlockModelImpl(FunctionBlockClass cls) throws ClassNotFoundException {
		...
		if (cls != null) {
			...
			for (final Entry<String, String> option : cls.getOptions().entrySet()) {
				...
				optionModel.setType("java.lang.String"); //$NON-NLS-1$
			}
		}
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.FUNCTION_BLOCK_MODEL__TYPE, oldType,
					type));
	}
	...
	public void setPosition(String newPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.FUNCTION_BLOCK_MODEL__POSITION,
	...
	public void setBlockName(String newBlockName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.FUNCTION_BLOCK_MODEL__BLOCK_NAME,
	 ...
	 * @generated
	 */
	public void setBlockClass(String newBlockClass) {
		String oldBlockClass = blockClass;
		blockClass = newBlockClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.FUNCTION_BLOCK_MODEL__BLOCK_CLASS,
					oldBlockClass, blockClass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ModelPackage.FUNCTION_BLOCK_MODEL__BLOCK_NAME:
			return getBlockName();
		case ModelPackage.FUNCTION_BLOCK_MODEL__BLOCK_CLASS:
	...
	public void eUnset(int featureID) {
		...
		case ModelPackage.FUNCTION_BLOCK_MODEL__BLOCK_NAME:
			...
			return;
		case ModelPackage.FUNCTION_BLOCK_MODEL__BLOCK_CLASS:
			setBlockClass(BLOCK_CLASS_EDEFAULT);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case ModelPackage.FUNCTION_BLOCK_MODEL__BLOCK_CLASS:
			return BLOCK_CLASS_EDEFAULT == null ? blockClass != null : !BLOCK_CLASS_EDEFAULT.equals(blockClass);
		}
	...
	public String toString() {
		...
		result.append(Messages.BLOCK_TOSTRING_TYPE);
		result.append(type);
		result.append(Messages.BLOCK_TOSTRING_ID);
		result.append(iD);
		result.append(Messages.BLOCK_TOSTRING_POSITION);
		result.append(position);
		result.append(Messages.BLOCK_TOSTRING_BLOCKNAME);
		result.append(blockName);
		result.append(Messages.BLOCK_TOSTRING_BLOCKCLASS);
