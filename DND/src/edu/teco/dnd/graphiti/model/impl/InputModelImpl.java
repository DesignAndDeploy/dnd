...
public class InputModelImpl extends EObjectImpl implements InputModel {
	...
	public FunctionBlockModel getFunctionBlock() {
		if (eContainerFeatureID() != ModelPackage.INPUT_MODEL__FUNCTION_BLOCK) return null;
	...
	public void setFunctionBlock(FunctionBlockModel newFunctionBlock) {
		if (newFunctionBlock != eInternalContainer() || (eContainerFeatureID() != ModelPackage.INPUT_MODEL__FUNCTION_BLOCK && newFunctionBlock != null)) {
			...
			if (newFunctionBlock != null)
				msgs = ((InternalEObject)newFunctionBlock).eInverseAdd(this, ModelPackage.FUNCTION_BLOCK_MODEL__INPUTS, FunctionBlockModel.class, msgs);
			msgs = basicSetFunctionBlock(newFunctionBlock, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.INPUT_MODEL__FUNCTION_BLOCK, newFunctionBlock, newFunctionBlock));
	}
	...
	public OutputModel getOutput() {
		if (output != null && output.eIsProxy()) {
			...
			if (output != oldOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.INPUT_MODEL__OUTPUT, oldOutput, output));
			}
		}
		return output;
	}
	...
	public NotificationChain basicSetOutput(OutputModel newOutput, NotificationChain msgs) {
		...
		output = newOutput;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.INPUT_MODEL__OUTPUT, oldOutput, newOutput);
	...
	public void setOutput(OutputModel newOutput) {
		if (newOutput != output) {
			NotificationChain msgs = null;
			if (output != null)
				msgs = ((InternalEObject)output).eInverseRemove(this, ModelPackage.OUTPUT_MODEL__INPUTS, OutputModel.class, msgs);
			if (newOutput != null)
				msgs = ((InternalEObject)newOutput).eInverseAdd(this, ModelPackage.OUTPUT_MODEL__INPUTS, OutputModel.class, msgs);
			msgs = basicSetOutput(newOutput, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.INPUT_MODEL__OUTPUT, newOutput, newOutput));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ModelPackage.INPUT_MODEL__FUNCTION_BLOCK:
				return eInternalContainer().eInverseRemove(this, ModelPackage.FUNCTION_BLOCK_MODEL__INPUTS, FunctionBlockModel.class, msgs);
		}
