...
public interface ModelFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Function Block Model</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Option Model</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Output Model</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
