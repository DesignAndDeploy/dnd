...
public interface FutureNotifier<V> extends Future<V> {
	 ...
	 * {@link FutureListener#operationComplete(FutureNotifier)} is called immediately, otherwise it is called as soon
	 * as the Future finishes.
	 * 
	 ...
	 * @param unit the unit for <code>timeout</code>
