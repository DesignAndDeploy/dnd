...
public class FileCache {
	...
	/**
	 * Retrieves the File's data. If the File's data is cached the cached value is returned. Otherwise the File is read
	 * and data is put into the cache. There is currently no way to invalidate a cache entry (for example if a File has
	 * been modified).
	 * 
	 * @param file
	 *            the File to read
