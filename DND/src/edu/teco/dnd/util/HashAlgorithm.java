...
public interface HashAlgorithm<T> {
	/**
	 * Returns the hash for the given data. If equal data is passed to the method, equal hashes have to be
	 * returned. For non equal data, non equal hashes should be returned, however hash collisions are allowed.
