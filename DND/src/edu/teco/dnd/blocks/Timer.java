...
/**
 * A timer is used to update {@link FunctionBlock}s at specified intervals. How acurate this updates are depends on the
 * scheduler used. Updates between two ticks may happen if inputs change.
 */
