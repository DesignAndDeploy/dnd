...
public class MessageAdapter implements JsonSerializer<Message>, JsonDeserializer<Message> {
	 ...
	 * 
	 * @param typeFieldName the type name to use
	 */
	 ...
	 * If either the class or the type name are already in use, nothing is done. Throws {@link IllegalArgumentException}
	 * if the type field attribute could not be retrieved or is not a String.
	 * 
	 * @param cls the class to add
