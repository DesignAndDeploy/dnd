...
/**
 * A deserializer for {@link BeaconMessage}s that uses the public constructor so that <code>addresses</code> is kept unmodifiable.
 * 
 * @author Philipp Adolf
 */
public class BeaconMessageDeserializer implements JsonDeserializer<BeaconMessage> {
	@Override
	public BeaconMessage deserialize(final JsonElement json, final Type typeOfT, final JsonDeserializationContext context) {
