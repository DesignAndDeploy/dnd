...
public class Messages extends NLS {
	...
	public static String DEPLOYGRAPHICS_CREATE_DISTRIBUTION;
	public static String DEPLOYGRAPHICS_DEPLOYBUTTON_TEXT;
	public static String DEPLOYGRAPHICS_DISTRIBUTED_AT;
	public static String DEPLOYGRAPHICS_DISTRIBUTED_ON;
